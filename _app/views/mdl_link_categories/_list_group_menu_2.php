...
echo '<div class="panel-group" id="accordion">' . chr(10);
	...
	echo '<h4 class="page_title">' . chr(10);
		echo '<a data-toggle="collapse" data-parent="#accordion" href="#CategoryList" class="page_title">Link Categories<span id="CategoryListGlyphicon" class="pull-right glyphicon glyphicon-minus"></span></a>' . chr(10);
	echo '</h4>' . chr(10);
    ...
    echo '<div id="CategoryList" class="panel-collapse collapse">' . chr(10);
		...
		echo '<div class="list-group">' . chr(10);
			...
			foreach ($categories as $category) {
				...
				echo '<a href="' . site_url('mdl-links/by-category/' . $category->id) . '" class="list-group-item thin ' . $background_color . '">';
