	...
	<div class="row">
		<div class="col col-md-12">
			...
			// echo '<div class="form-group">' . chr(10);
				...
				// $input_attributes = array('name' => 'sort_order', 'id' => 'sort_order', 'value'  => (set_value('sort_order') == '' ? @$link_category->sort_order : set_value('sort_order')), 'maxlength' => '5', 'class' => 'form-control');
				// echo form_input($input_attributes) . chr(10);
			// echo '</div>' . chr(10);
