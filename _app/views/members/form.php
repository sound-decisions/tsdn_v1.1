	...
	<div class="row">
		<div class="col col-md-12">
			...
			echo '<div class="form-group">' . chr(10);
				...
				$input_attributes = array('name' => 'first_name', 'id' => 'first_name', 'value'  => (set_value('first_name') == '' ? $member->first_name : set_value('first_name')), 'maxlength' => '50', 'autofocus' => 'autofocus', 'class' => 'form-control');
			...
			echo '</div>' . chr(10);	
			// echo '<div class="form-group">' . chr(10);
			// 	echo form_label('Current Issue Cover Thumbnail', 'current_profile_photo_tn', $label_attributes) . chr(10);
			// 	$input_attributes = array('name' => 'current_profile_photo_tn', 'id' => 'current_profile_photo_tn', 'value'  => (set_value('current_profile_photo_tn') == '' ? $member->profile_photo_tn : set_value('current_profile_photo_tn')), 'class' => 'form-control');
			// 	echo form_input($input_attributes) . chr(10);
			// echo '</div>' . chr(10);
