<div class="container">
	<div class="row">
		<div class="col col-md-7">
			...
			echo '<p>To become a Member of ' . DISPLAY_SITE_NAME . ' please fill out the form below and click on the \'Sign Up\' button.</p>' . chr(10);
			...
			echo '<div class="panel panel-form">' . chr(10);
				...
				echo '<div class="panel-body">' . chr(10);
					...
					echo '<div class="form-group margin-top-10">' . chr(10);
						$submit_attributes = array('names' => 'save', 'value' => 'Sign Up', 'class' => 'btn btn-primary btn-sm');
		...
		<div class="col col-md-5">
			...
			<p>Keep track of your Movie Collection.  
				...
				Review and Rate Movies to help other Members pick which Movies to watch.</p>
