	...
	<div class="row">	
		...
		<div class="col col-xs-12 col-sm-9 col-lg-9">
			...
			echo '<div class="detail_section">' . chr(10);
				...
				echo '<div class="clearfix">' . chr(10);
					echo '<p class="' . $label_class . '">Membership Level:</p>' . chr(10);
					echo '<p class="' . $content_class . '">' . $member->membership_level . '</p>' . chr(10);
				echo '</div>' . chr(10);
				echo '<div class="clearfix">' . chr(10);
					echo '<p class="' . $label_class . '">Role:</p>' . chr(10);
					echo '<p class="' . $content_class . '">' . $member->role . '</p>' . chr(10);
				echo '</div>' . chr(10);								
				...
				echo '<div class="clearfix">' . chr(10);
					echo '<div class="pull-right margin-top-10">' . chr(10);
						...
						echo '<div>';
							echo '<a href="' . site_url('members/edit/' . $member->id . '') . '" class="btn btn-primary">Edit Member Details</a>';
