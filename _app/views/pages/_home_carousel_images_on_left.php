					...
					<div class="col col-md-12">
						...
						<div class="slide_content">
							...
							<div class="<?php echo $div_text_holder; ?>">
								...
								<p>Search, Browse and Display Movie Information, manage your own Movie Collection, indicate which Movies you have seen, create a Watch List of Movies you want to see, rate and review movies.</p>
								<div class="hidden-xs">
					...
					<div class="col col-md-12">
						...
						<div class="slide_content">
							...
							<div class="<?php echo $div_text_holder; ?>">
								...
								<p>Keep track of the Recipes you use the most, add Notes to your Recipes to keep track of different things you have tried and what worked and what didn't.</p>								
								<div class="hidden-xs">
					...
					<div class="col col-md-12">
						...
						<div class="slide_content">
							...
							<div class="<?php echo $div_text_holder; ?>">
								...
								<p>Store all of your favorite Website Links Online so they are available where ever you happen to be, keep track of Login Information for all of the Websites.</p>
								<div class="hidden-xs">
					...
					<div class="col col-md-12">
						...
						<div class="slide_content">
							...
							<div class="<?php echo $div_text_holder; ?>">
								...
								<p>Instead of writing Notes on pieces of paper and have them lying around all over the place, create and store your Notes here and save them by Category or sub-category so finding them again is really easy.</p>
								<div class="hidden-xs">
					...
					<div class="col col-md-12">
						...
						<div class="slide_content">
							...
							<div class="<?php echo $div_text_holder; ?>">
								...
								<p>We create some Websites you may find interesting or useful in some way.  Trying to Lose Some Weight?  Check out 'I Want To Be A Loser'.  Are you a fan of NFL Football?  Create and/or Join a NFL Pool and Pick the Winners each week.</p>	
								<div class="hidden-xs">
